...
create table login(
    username varchar(50), --il peut être un email,nom prénom ...etc
    password varchar(15),
    user_id integer,
    role boolean
);
...
create table bos(
    ...
    status varchar(30),
    bos_flag boolean -- c'est quoi ?
);

create table commentaire(
    commentaire_id integer primary key not null,
    visibilite_flag integer, --c'est quoi ?
...
/*
create or replace procedure insert_personnel(_personnel_id integer,
    _nom varchar(30),
    _prenom varchar(30),
    _mail varchar(50),
